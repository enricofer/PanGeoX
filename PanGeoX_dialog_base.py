...
#
# Created: Thu Jul 09 14:23:16 2015
...
class Ui_PanGeoXDialogBase(object):
    def setupUi(self, PanGeoXDialogBase):
        ...
        PanGeoXDialogBase.resize(1293, 313)
        ...
        self.webView.setMinimumSize(QtCore.QSize(1280, 305))
        self.webView.setMaximumSize(QtCore.QSize(1280, 305))
    ...
    def retranslateUi(self, PanGeoXDialogBase):
        PanGeoXDialogBase.setWindowTitle(_translate("PanGeoXDialogBase", "visual surveys", None))
